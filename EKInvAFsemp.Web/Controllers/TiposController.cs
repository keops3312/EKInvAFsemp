...
namespace EKInvAFsemp.Web.Controllers
{
    public class TiposController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdTipos,Tipo,Descripcion,Alta,Operador,imagen,ActInac,NombreTipo")] Tipos tipos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdTipos,Tipo,Descripcion,Alta,Operador,imagen,ActInac,NombreTipo")] Tipos tipos)
        {
            if (ModelState.IsValid)
            {
